    ...
    <section className="my-12 px-48 py-6 flex flex-col gap-20">
      <div className="flex justify-between  bg-primary px-12 py-16  text-white ">
        <div className="w-[45%] gap-8 flex flex-col h-full">
          <p className="w-[50%] rounded-lg bg-[#386A8B] py-3 px-6 text-[18px] text-center ">
            For patients
          </p>
          <h4 className="text-4xl font-semibold">
            Access the benefits of the healthcare system.
          </h4>
          <p className="text-[22px] my-4">
            Integrated platform for your healthcare needs across supplies and
            services.
          </p>
      ...
      <div className="flex justify-between items-center gap-3 bg-[#62909F] px-12 py-16 text-white  ">
        <div className="w-[40%] gap-8 flex flex-col h-full pb-6">
          <p className="w-[50%] text-[18px] rounded-lg bg-[#386A8B] py-3 px-6 text-center">
            For providers
          </p>
          <h4 className="text-4xl font-semibold">
          ...
          <p className="text-[22px] my-4">
            Digitalize your healthcare operations across sales, supply chain,
            customer relations and back-office, for internal management needs.
            Data sharing with patients and other stakeholders for external relations.
          </p>
          <button className="w-[40%] rounded-sm text-[#386A8B] bg-white p-3  text-center text-sm">
            GET STARTED
          </button>
